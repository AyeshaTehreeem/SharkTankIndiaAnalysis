...
LOAD DATA INFILE "E:/Exercise/sharktank.csv"
...
-- 1 How can you promote shark tank season 4? What are the highest funded domains?
	select * from
	(
...
-- 2 Which domains have female to male pitcher ratio >70%?
...
-- 3 Imagine you are working in the marketing firm of Shark tank, find volume of yearly sales pitches made, pitches that received offers, and pitches that were converted. Also calculates the percentages of pitches received and converted based on the total pitches.
...
-- 6. How can we create a system to assist each shark in determining the expected timeline 
-- for their investment to be returned based on the total deal amount and equity they have in a startup?
...
-- 7. Who among the well-known investors, often called "sharks," tends to invest the most money on average in startup deals, giving us insight into 
-- their generosity and comparing their investment patterns with other investors?
...
-- 9. Which shark in the venture capital sphere has the most diversified investment portfolio across different
-- industries? By analyzing their investment patterns and preferences, we seek to identify any notable 
-- trends or strategies that might illuminate their decision-making methods and investment philosophies.
